// NOTE: The terms "brAInwav", "glass-morphism", etc. are intentional brand/utility names for the brAInwav platform.
// If your linter or spellchecker flags these as unknown words, you may safely ignore or add them to your dictionary.
